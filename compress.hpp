...
namespace itertools{
    ...
    public:
        ...
        public:
            explicit iterator(typename CONTAINER::iterator begin,typename CONTAINER::iterator end,typename CONTAINER_B::iterator b_begin) :cont_begin_iter1(begin),cont_end_iter1(end),bool_begin_iter1(b_begin)
            {
            ...
            //return value before increment. i++
            iterator operator++(int)
            {
                iterator temp_ = *this; ++(*this); return temp_;
            };
            bool operator==(const iterator& other )
            {
                return cont_begin_iter1 == other.cont_begin_iter1;
            }
            bool operator!=(const iterator& other )
            {
                return cont_begin_iter1 != other.cont_begin_iter1;
            ...
            auto operator *()
            {
                return *cont_begin_iter1;
            }
        };
        iterator begin() const {
            return iterator(container1.begin(), container1.end(), container_b.begin());
        }
        iterator end()   const
        {
            return iterator(container1.end(), container1.end(), container_b.end());
        }
    };
