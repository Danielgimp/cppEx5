...
namespace itertools{
    ...
    public:
        ...
        class iterator{
            ...
            FUNCTION function1;
        public:
            explicit iterator(typename CONTAINER::iterator begin,typename CONTAINER::iterator end,FUNCTION function):begin_iter1(begin),end_iter1(end),function1(function)
            {
            ...
            {
                iterator temp_ = *this; ++(*this);
                return temp_;
            };
            bool operator==(const iterator& other )
            {
                return begin_iter1 == other.begin_iter1;
            }
            bool operator!=(const iterator& other )
            {
                return begin_iter1 != other.begin_iter1;
        ...
        {
            return iterator(container1.begin(), container1.end(), function1);
        }
        iterator end()const
        {
            return iterator(container1.end(), container1.end(), function1);
        }
    };
