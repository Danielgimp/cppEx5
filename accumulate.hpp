...
namespace itertools {
    ...
    public:
        ...
        public:
            ...
            explicit iterator(typename CONTAINER::iterator begin_iter, typename CONTAINER::iterator end_iter,FUNCTION function):begin_iter(begin_iter),end_iter(end_iter),function(function)
            {
            ...
            iterator operator++(int) {
                iterator temp_it = *this; ++(*this); return temp_it;
            };
            bool operator==(const iterator& other )const
            {
                return begin_iter == other.begin_iter;
            }
            bool operator!=(const iterator& other )const
            {
                return begin_iter != other.begin_iter;
